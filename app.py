...
with tab_viz:
    ...
    with st.expander("Generic Visualise (any dataset)"):
        ...
        use_generic = st.toggle("Priority is given to using the view generated by Column Mapper (if available).", value=True if gv is not None else False)
        ...
        chart = st.selectbox("Chart Type", ["Histogram", "Bar (agg)", "Line (time)", "Scatter", "Correlation Heatmap"])
